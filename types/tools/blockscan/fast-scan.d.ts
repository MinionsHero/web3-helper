...
export declare class FastBscScan extends FastScan {
    constructor(apiKeys: string[], providers: ethers.providers.JsonRpcProvider[], output: string);
}
export declare class FastEtherScan extends FastScan {
    constructor(apiKeys: string[], providers: ethers.providers.JsonRpcProvider[], output: string);
}
export declare class FastBTTCScan extends FastScan {
    constructor(apiKeys: string[], providers: ethers.providers.JsonRpcProvider[], output: string);
}
